...
function subscribe() {
	...
	if (emailsub != "" && emailreg.test(emailsub)) {
		var checkemail;
		if (request) {
			request.abort();
		}
		...
		request.done(function (response, textStatus, jqXHR) {
			...
			if (checkemail == "successfull") {
				demo.showNotification("bottom", "right", "<b>Newsletter :</b> Subscribe Successfully ")

			}
			else if (checkemail == "exist") {
				demo.showNotification("bottom", "right", "<b>Newsletter :</b> Already Subscribed ")
			}
			else {
				demo.showNotification("bottom", "right", "<b>Newsletter :</b> Subscribe Failed ")
			}
		});
	}else
	{
		demo.showNotification("bottom", "right", "<b>Newsletter :</b> Please Enter A valid Email ")
	}
}
